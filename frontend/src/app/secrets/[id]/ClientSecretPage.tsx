...
export default function ClientSecretPage({ id }: { id: string }) {
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={cn(
                      ...
                      showRaw ? 'bg-danger/10 border-danger/30 text-danger' : 'bg-bg-hover border-border text-text-secondary hover:text-text-primary',
                    )}
                  >
              ...
              <div className={cn('mono text-sm bg-black/30 border border-border rounded-lg px-3 py-2', showRaw && 'border-danger/30 bg-danger/5')}>
